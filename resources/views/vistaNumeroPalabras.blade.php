    ...
    <body class="bg-slate-300">
        <section class="container mx-auto bg-slate-300">
            ...
            <section class="bg-yellow-200f  top-0 left-0 h-full z-10 flex flex-col items-center  justify-start">
                <form action="{{route('obtenerNumeroPalabras')}}" method="post" class="bg-gradient-to-tl from-white to-indigo-900 shadow-md rounded px-8 pt-4 pb-8 mb-4 mt-4">
                    @csrf                
                    <!--cadena-->
            ...
            @isset($contadorPalabras)
                <section>
                    En la cadena "{{ $cadena }}" el resultado es: {{ $contadorPalabras }}
                </section>
            @endisset
        </section>
    </body>
